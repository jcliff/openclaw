...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "diagnostics.envelopeMin": "Envelope Minimization",
  "diagnostics.envelopeMin.enabled": "Envelope Minimization Enabled",
  "diagnostics.envelopeMin.agents": "Envelope Minimization Agent Allowlist",
  "diagnostics.envelopeMin.providers": "Envelope Minimization Provider Allowlist",
  "diagnostics.envelopeMin.omitPromptEnvelope": "Omit Prompt Envelope Blocks",
