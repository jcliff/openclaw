...
## Live: CLI backend smoke (local CLIs)
...
- Provide a backend explicitly (no built-in defaults):
  - `OPENCLAW_LIVE_CLI_BACKEND_MODEL="my-cli/my-model"`
  - `OPENCLAW_LIVE_CLI_BACKEND_COMMAND="/full/path/to/your-cli"`
  - `OPENCLAW_LIVE_CLI_BACKEND_ARGS='["--json"]'`
